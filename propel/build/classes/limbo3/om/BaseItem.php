...
abstract class BaseItem extends BaseObject  implements Persistent
{
	...
	public function setUpc($v)
	{
		...
		if ($this->upc !== $v) {
			$this->upc = $v;
			$this->modifiedColumns[] = ItemPeer::UPC;
		}
	...
	public function setCreated($v)
	{
		...
		if ( $this->created !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ItemPeer::CREATED;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->upc = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = ItemPeer::NUM_COLUMNS - ItemPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setUpc($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ItemPeer::UPC)) $criteria->add(ItemPeer::UPC, $this->upc);
		if ($this->isColumnModified(ItemPeer::CREATED)) $criteria->add(ItemPeer::CREATED, $this->created);
	 ...
	 * @return     PropelCollection|array Stock[] List of Stock objects
	 */
	public function getStocksJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = StockQuery::create(null, $criteria);
