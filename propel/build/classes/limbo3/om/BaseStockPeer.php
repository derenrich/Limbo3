...
abstract class BaseStockPeer {
	...
	const CLASS_DEFAULT = 'limbo3.Stock';
	...
	const CREATED = 'stock.CREATED';

	/** the column name for the SOLD_OUT field */
	const SOLD_OUT = 'stock.SOLD_OUT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ItemId', 'UserId', 'Price', 'Created', 'SoldOut', 'Quantity', 'Sold', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'itemId', 'userId', 'price', 'created', 'soldOut', 'quantity', 'sold', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ITEM_ID, self::USER_ID, self::PRICE, self::CREATED, self::SOLD_OUT, self::QUANTITY, self::SOLD, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ITEM_ID', 'USER_ID', 'PRICE', 'CREATED', 'SOLD_OUT', 'QUANTITY', 'SOLD', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'item_id', 'user_id', 'price', 'created', 'sold_out', 'quantity', 'sold', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ItemId' => 1, 'UserId' => 2, 'Price' => 3, 'Created' => 4, 'SoldOut' => 5, 'Quantity' => 6, 'Sold' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'itemId' => 1, 'userId' => 2, 'price' => 3, 'created' => 4, 'soldOut' => 5, 'quantity' => 6, 'sold' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ITEM_ID => 1, self::USER_ID => 2, self::PRICE => 3, self::CREATED => 4, self::SOLD_OUT => 5, self::QUANTITY => 6, self::SOLD => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ITEM_ID' => 1, 'USER_ID' => 2, 'PRICE' => 3, 'CREATED' => 4, 'SOLD_OUT' => 5, 'QUANTITY' => 6, 'SOLD' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'item_id' => 1, 'user_id' => 2, 'price' => 3, 'created' => 4, 'sold_out' => 5, 'quantity' => 6, 'sold' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(StockPeer::ITEM_ID);
			$criteria->addSelectColumn(StockPeer::USER_ID);
			$criteria->addSelectColumn(StockPeer::PRICE);
			$criteria->addSelectColumn(StockPeer::CREATED);
			$criteria->addSelectColumn(StockPeer::SOLD_OUT);
			$criteria->addSelectColumn(StockPeer::QUANTITY);
			$criteria->addSelectColumn(StockPeer::SOLD);
		} else {
			...
			$criteria->addSelectColumn($alias . '.SOLD_OUT');
	 ...
	 *
	 * @param      Stock $value A Stock object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Stock $obj, $key = null)
	{
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = StockPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + StockPeer::NUM_COLUMNS;
		} else {
	...
	public static function doCountJoinItem(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(StockPeer::ITEM_ID, ItemPeer::ID, $join_behavior);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(StockPeer::USER_ID, UserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Stock objects pre-filled with their Item objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinItem(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		StockPeer::addSelectColumns($criteria);
		$startcol = (StockPeer::NUM_COLUMNS - StockPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Stock) to $obj2 (Item)
				$obj2->addStock($obj1);
	...
	/**
	 * Selects a collection of Stock objects pre-filled with their User objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Stock objects.
	...
	public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Stock) to $obj2 (User)
				$obj2->addStock($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		StockPeer::addSelectColumns($criteria);
		$startcol2 = (StockPeer::NUM_COLUMNS - StockPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Stock) to the collection in $obj2 (Item)
				$obj2->addStock($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Stock) to the collection in $obj3 (User)
				$obj3->addStock($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Stock objects pre-filled with all related objects except Item.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptItem(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = StockPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Stock) to the collection in $obj2 (User)
				$obj2->addStock($obj1);
	...
	/**
	 * Selects a collection of Stock objects pre-filled with all related objects except User.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
		return $withPrefix ? StockPeer::CLASS_DEFAULT : StockPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Stock or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Stock or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the stock table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Stock or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(Stock $obj, $cols = null)
	{
		$columns = array();
