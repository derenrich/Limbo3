 ...
 * @method     ItemQuery orderByUpc($order = Criteria::ASC) Order by the UPC column
 ...
 * @method     ItemQuery groupByUpc() Group by the UPC column
 ...
 * @method     Item findOneByUpc(string $UPC) Return the first Item filtered by the UPC column
 ...
 * @method     array findByUpc(string $UPC) Return Item objects filtered by the UPC column
...
abstract class BaseItemQuery extends ModelCriteria
{
	...
	public function filterByUpc($upc = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(ItemPeer::UPC, $upc, $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(ItemPeer::ID, $purchase->getItemId(), $comparison);
	}
