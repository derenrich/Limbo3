...
abstract class BasePurchase extends BaseObject  implements Persistent
{
	...
	public function setStockId($v)
	{
		...
		if ($this->stock_id !== $v) {
			$this->stock_id = $v;
			$this->modifiedColumns[] = PurchasePeer::STOCK_ID;
		}
	...
	public function setItemId($v)
	{
		...
		if ($this->item_id !== $v) {
			$this->item_id = $v;
			$this->modifiedColumns[] = PurchasePeer::ITEM_ID;
		}
	...
	public function setCreated($v)
	{
		...
		if ( $this->created !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PurchasePeer::CREATED;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->stock_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(PurchasePeer::ID) ) {
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			...
			if (null !== $this->aStock) {
				$result['Stock'] = $this->aStock->toArray($keyType, $includeLazyLoadColumns, true);
			}
			if (null !== $this->aItem) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PurchasePeer::STOCK_ID)) $criteria->add(PurchasePeer::STOCK_ID, $this->stock_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setStockId($this->stock_id);
	...
	public function setStock(Stock $v = null)
	{
		...
		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Stock object, it will not be re-added.
		if ($v !== null) {
			$v->addPurchase($this);
		}
