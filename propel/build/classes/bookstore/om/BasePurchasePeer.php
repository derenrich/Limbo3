...
abstract class BasePurchasePeer {
	...
	const CLASS_DEFAULT = 'bookstore.Purchase';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Stock', 'Quantity', 'Created', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'stock', 'quantity', 'created', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::STOCK, self::QUANTITY, self::CREATED, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'STOCK', 'QUANTITY', 'CREATED', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'stock', 'quantity', 'created', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Stock' => 2, 'Quantity' => 3, 'Created' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'stock' => 2, 'quantity' => 3, 'created' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::STOCK => 2, self::QUANTITY => 3, self::CREATED => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'STOCK' => 2, 'QUANTITY' => 3, 'CREATED' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'stock' => 2, 'quantity' => 3, 'created' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(PurchasePeer::STOCK);
