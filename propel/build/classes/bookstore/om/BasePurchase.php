...
abstract class BasePurchase extends BaseObject  implements Persistent
{
  ...
  const PEER = 'PurchasePeer';
	...
	public function setStock($v)
	{
		...
		if ($this->stock !== $v) {
			$this->stock = $v;
			$this->modifiedColumns[] = PurchasePeer::STOCK;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->stock = ($row[$startcol + 2] !== null) ? (double) $row[$startcol + 2] : null;
			...
			return $startcol + 5; // 5 = PurchasePeer::NUM_COLUMNS - PurchasePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PurchasePeer::STOCK)) $criteria->add(PurchasePeer::STOCK, $this->stock);
