...
abstract class BaseStockPeer {
	...
	const CLASS_DEFAULT = 'bookstore.Stock';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ItemId', 'Balance', 'Created', 'Upc', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'itemId', 'balance', 'created', 'upc', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ITEM_ID, self::BALANCE, self::CREATED, self::UPC, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ITEM_ID', 'BALANCE', 'CREATED', 'UPC', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'item_id', 'balance', 'created', 'UPC', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ItemId' => 1, 'Balance' => 2, 'Created' => 3, 'Upc' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'itemId' => 1, 'balance' => 2, 'created' => 3, 'upc' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ITEM_ID => 1, self::BALANCE => 2, self::CREATED => 3, self::UPC => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ITEM_ID' => 1, 'BALANCE' => 2, 'CREATED' => 3, 'UPC' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'item_id' => 1, 'balance' => 2, 'created' => 3, 'UPC' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(StockPeer::BALANCE);
			$criteria->addSelectColumn(StockPeer::CREATED);
			$criteria->addSelectColumn(StockPeer::UPC);
		} else {
