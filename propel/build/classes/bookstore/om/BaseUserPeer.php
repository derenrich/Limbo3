...
abstract class BaseUserPeer {
	...
	const CLASS_DEFAULT = 'bookstore.User';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Email', 'Balance', 'Created', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'email', 'balance', 'created', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::EMAIL, self::BALANCE, self::CREATED, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'EMAIL', 'BALANCE', 'CREATED', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'email', 'balance', 'created', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Email' => 2, 'Balance' => 3, 'Created' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'email' => 2, 'balance' => 3, 'created' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::EMAIL => 2, self::BALANCE => 3, self::CREATED => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'EMAIL' => 2, 'BALANCE' => 3, 'CREATED' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'email' => 2, 'balance' => 3, 'created' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
